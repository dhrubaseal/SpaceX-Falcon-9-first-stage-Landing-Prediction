...
def get_scatter(value1, value2):
    filtered_slider=spacex_df[(spacex_df['Payload Mass (kg)'] > value2[0]) & (spacex_df['Payload Mass (kg)'] < value2[1])]
    if value1 == 'All Sites':
        fig= px.scatter(filtered_slider,x="Payload Mass (kg)",y="class",color="Booster Version Category",\
        title="Correlation between Payload and Success for All sites")
        return fig

    else:
        filtered_slider = filtered_slider[filtered_slider['Launch Site'] == value1]
        fig= px.scatter(filtered_slider,x="Payload Mass (kg)",y="class",color="Booster Version Category",\
